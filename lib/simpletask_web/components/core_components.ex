defmodule SimpletaskWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SimpletaskWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SimpletaskWeb.Gettext, "errors", msg, opts)
    end
  end
